...
export function autoRoute(text) {
  const t = text.toLowerCase();
  const routes = [
    {
      kw: ["leak", "water", "pipe", "tap", "drain", "flush", "bathroom", "toilet", "plumb", "sewage", "overflow"],
      role: "Plumber",
      person: "Rajesh M",
      id: "S01"
    },
    {
      kw: ["chair", "door", "wood", "furniture", "table", "cabinet", "shelf", "window", "lock", "hinge", "broken furniture"],
      role: "Carpenter",
      person: "Murugan K",
      id: "S02"
    },
    {
      kw: ["power", "electric", "switch", "light", "fan", "wiring", "mcb", "socket", "generator", "transformer", "voltage", "short circuit", "fuse", "trip"],
      role: "Electrician",
      person: "Rajan Kumar",
      id: "S03"
    },
    {
      kw: ["ac", "air condition", "cooling", "compressor", "hvac", "not cooling", "hot"],
      role: "Electrician",
      person: "Suresh P",
      id: "S04"
    },
    {
      kw: ["network", "internet", "wifi", "computer", "printer", "server", "software", "cctv", "camera", "it", "monitor", "email"],
      role: "IT Support",
      person: "Arun M",
      id: "S05"
    },
    {
      kw: ["clean", "garbage", "pest", "garden", "painting", "sweep", "mop", "dust", "stain", "smell"],
      role: "Helper",
      person: "Vinod R",
      id: "S06"
    },
    {
      kw: ["elevator", "lift", "stuck", "door sensor", "kone"],
      role: "Electrician",
      person: "Suresh P",
      id: "S04"
    }
  ...
  return { role: "General", person: "Vinod R", id: "S06" };
}
